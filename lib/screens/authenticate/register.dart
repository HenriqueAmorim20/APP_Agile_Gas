                  ...
                  Container(
                    ...
                    child: TextFormField(
                        ...
                        validator: (val) => val.length < 6
                            ? 'Insira uma senha com +6 caracteres'
                            : null, //verifica se a senha é menor que 6 caracteres
                        onChanged: (val) {
                          //toda vez que o valor do campo mudar
                          setState(() => password =
                              val); //mude o valor da variaǘel senha para o valor do campo
                        }),
                  ),
                  Image.asset('images/line.png',
                      color: Colors.red.withOpacity(0.5), width: 200),
